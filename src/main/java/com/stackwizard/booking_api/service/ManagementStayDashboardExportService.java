...
@Service
public class ManagementStayDashboardExportService {
    ...
    public ManagementStayDashboardExportService(ManagementStayDashboardService stayDashboardService) {
    ...
    public byte[] exportRevenueByProduct(Long tenantId, OffsetDateTime from, OffsetDateTime to) {
        List<ManagementStayDashboardProductRow> rows = stayDashboardService.getRevenueByProduct(tenantId, from, to);
        ...
        try (SXSSFWorkbook workbook = new SXSSFWorkbook(100);
            ...
            for (ManagementStayDashboardProductRow row : rows) {
                ...
                sheetRow.createCell(4).setCellValue(row.getInvoiceLineCount());
                sheetRow.createCell(5).setCellValue(row.getQuantitySum());
            ...
            throw new IllegalStateException("Failed to generate stay dashboard export", ex);
        }
    }
